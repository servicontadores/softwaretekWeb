...
@Entity
@NamedQueries({
    @NamedQuery(name = "Contablea.findAll", query = "SELECT c FROM Contablea c")})
public class Contablea implements Serializable {
    ...
    public Contablea(String codigoUsuario) {
        this.codigoUsuario = codigoUsuario;
    }

    public Contablea(String codigoUsuario, int odbcfixFldauto) {
        this.codigoUsuario = codigoUsuario;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Contablea)) {
            return false;
        }
        Contablea other = (Contablea) object;
    ...
    public String toString() {
        return "entities.Contablea[ codigoUsuario=" + codigoUsuario + " ]";
    }
