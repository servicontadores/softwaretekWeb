...
public class Consignacion implements Serializable {
    ...
    public Consignacion(Integer keygen) {
        this.keygen = keygen;
    }

    public Consignacion(Integer keygen, int cody, int codigoConcepto, int odbcfixFldauto, boolean noDocAuto) {
        this.keygen = keygen;
        this.cody = cody;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Consignacion)) {
            return false;
        }
        Consignacion other = (Consignacion) object;
    ...
    public String toString() {
        return "entities.Consignacion[ keygen=" + keygen + " ]";
    }
