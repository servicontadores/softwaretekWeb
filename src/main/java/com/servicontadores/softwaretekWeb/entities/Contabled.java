...
@Entity
@NamedQueries({
    @NamedQuery(name = "Contabled.findAll", query = "SELECT c FROM Contabled c")})
public class Contabled implements Serializable {
    ...
    public Contabled(String codigoUsuario) {
        this.codigoUsuario = codigoUsuario;
    }

    public Contabled(String codigoUsuario, int odbcfixFldauto) {
        this.codigoUsuario = codigoUsuario;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Contabled)) {
            return false;
        }
        Contabled other = (Contabled) object;
    ...
    public String toString() {
        return "entities.Contabled[ codigoUsuario=" + codigoUsuario + " ]";
    }
